...
<%--    </div>--%>
    ...
    <!-- Blog Hero Begin -->
    <div class="blog-hero set-bg" data-setbg="${blogs.getBlogId().getImg()}">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-7">
                    <div class="blog__hero__text">
                        <div class="label">${blogs.getBlogId()}</div>
                        <h2>${blogs.getBlogId().getTittle()}</h2>
                        <ul>
                            <li>Bài viết của: <span>CakeShop</span></li>
                            <li>${blogs.getBlogId().getDatePost()}</li>
                        </ul>
                    </div>
                </div>
            </div>
