...
<%--                                <a href="#"><i class="fa fa-twitter"></i></a>--%>
                            ...
                            <div class="blog__sidebar__recent">
                                <a href="#" class="blog__sidebar__recent__item">
                                    ...
                                    <div class="blog__sidebar__recent__item__text">
                                        <h4><a href="/blogDetail?action=view&id=${blog.getBlogId()}&blogCateId=${blog.getBlogCateId()}">${b.tittle}</a></h4>
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <c:forEach items="${requestScope.blogC}" var="bCate">
                            <div class="blog__sidebar__item__categories">
                                <ul>
                                    <li><a href="#">${bCate.blogName} <span>36</span></a></li>
                                </ul>
                            </div>
                            </c:forEach>
                        </div>
